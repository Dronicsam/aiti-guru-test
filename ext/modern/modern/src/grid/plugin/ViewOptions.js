...
Ext.define("Ext.grid.plugin.ViewOptions", {
  ...
  config: {
    ...
    columnList: {
      ...
      listConfig: {
        ...
        itemTpl: [
          '<div class="' +
            Ext.baseCSSPrefix +
            'column-options-itemwrap<tpl if="hidden"> {hiddenCls}</tpl>',
          '<tpl if="grouped"> {groupedCls}</tpl>">',
          '<div class="' +
            Ext.baseCSSPrefix +
            'column-options-sortablehandle"></div>',
          '<tpl if="header">',
          ...
          '<div class="' +
            Ext.baseCSSPrefix +
            'column-options-text">{text}</div>',
          '<tpl if="groupable && dataIndex">',
          '<div class="' +
            Ext.baseCSSPrefix +
            'column-options-groupindicator"></div>',
          "</tpl>",
          '<div class="' +
            Ext.baseCSSPrefix +
            'column-options-visibleindicator"></div>',
          "</div>",
        ],
        triggerEvent: null,
        bufferSize: 1,
    ...
    visibleIndicatorSelector:
      "." + Ext.baseCSSPrefix + "column-options-visibleindicator",
