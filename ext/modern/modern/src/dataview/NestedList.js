...
Ext.define("Ext.dataview.NestedList", {
  ...
  onSelectionChange: function () {
    this.fireEvent.apply(
      this,
      [].concat("selectionchange", this, Array.prototype.slice.call(arguments)),
    );
  },
  ...
  applyToolbar: function (config) {
    if (config && config.splitNavigation) {
      ...
      var containerConfig =
        config.splitNavigation === true ? {} : config.splitNavigation;
  ...
  syncToolbar: function (forceDetail) {
    var me = this,
      ...
      node = me.getLastNode(),
      detailActive =
        forceDetail || (detailCard && me.getActiveItem() == detailCard),
