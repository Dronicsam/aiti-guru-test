xdescribe("Ext.env.Browser and Ext.env.OS", function () {
  var profiles = {
    Safari_502_Mac: {
      platform: "MacIntel",
      userAgent:
        "Safari_5533.18.5Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_6_4; en-us) AppleWebKit/533.18.1 (KHTML, like Gecko) Version/5.0.2 Safari/533.18.5",
      expect: {
        browser: {
          name: "Safari",
          flags: [
    ...
    Android_22_G2: {
      ...
      userAgent:
        " Mozilla/5.0 (Linux; U; Android 2.2; en-us; T-Mobile G2 Build/ FRF91) AppleWebKit/533.1(KHTML, like Gecko) Version/4.0 Mobile Safari/533.1",
      expect: {
        browser: {
          name: "Safari",
          flags: [
    ...
    Android_22_Desire: {
      platform: "Linux armv7l",
      userAgent:
        "Mozilla/5.0 (Linux; U; Android 2.2; en-vn; Desire_A8181 Build/FRF91) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1",
      expect: {
        browser: {
          name: "Safari",
          flags: [
    ...
    Android_21_GalaxyS: {
      platform: "Linux armv7l",
      userAgent:
        "Mozilla/5.0 (Linux; U; Android 2.1-update1; fr-fr; GT-I9000 Build/ECLAIR) AppleWebKit/530.17 (KHTML, like Gecko) Version/4.0 Mobile Safari/530.17",
      expect: {
        browser: {
          name: "Safari",
          flags: [
    ...
    "Android 2.3.3 / Motorola Droid X": {
      platform: "Linux armv7l",
      userAgent:
        "Mozilla/5.0 (Linux; U; Android 2.3.3; en-us; DROIDX Build/4.5.1_57_DX5-26) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1",
      expect: {
        browser: {
          name: "Safari",
          flags: [
    ...
    "HTC_Sensation_Z710e with OSX userAgent": {
      platform: "",
      userAgent:
        "Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_6_3; HTC_Sensation_Z710e; en-gb) AppleWebKit/533.16 (KHTML, like Gecko) Version/5.0 Safari/533.16",
      expect: {
        browser: {
          name: "Safari",
          flags: [
    ...
    "Galaxy Nexus ICS Chrome": {
      platform: "",
      userAgent:
        "Mozilla/5.0 (Linux; U; Android 4.0.3; en-us; Galaxy Nexus Build/ICL53F) AppleWebKit/535.7 (KHTML, like Gecko) CrMo/16.0.912.75 Mobile Safari/535.7",
      expect: {
        browser: {
          name: "ChromeMobile",
          flags: [
    ...
    "Samsung Galaxy S3 w/Opera Mobile": {
      platform: "",
      userAgent:
        "Mozilla/5.0 (Linux; Android 4.1.2; GT-I9300 Build/JZO54K) AppleWebKit/537.22 (KHTML, like Gecko) Chrome/25.0.1364.123 Mobile Safari/537.22 OPR/14.0.1025.53005",
      expect: {
        browser: {
          name: "Opera",
          flags: [
    ...
    "Motorola Droid Bionic w/Opera Mobile": {
      platform: "",
      userAgent:
        "Mozilla/5.0 (Linux; Android 2.3.4; DROID BIONIC Build/5.5.1_84_DBN-74) AppleWebKit/537.22 (KHTML, like Gecko) Chrome/25.0.1364.123 Mobile Safari/537.22 OPR/14.0.1025.53005",
      expect: {
        browser: {
          name: "Opera",
          flags: [
    ...
    "Tizen SDK 2.0": {
      platform: "",
      userAgent:
        "Mozilla/5.0 (Linux; U; Tizen 2.0; en-us) AppleWebKit/537.1 (KHTML, like Gecko) Version/2.0 Mobile",
      expect: {
        browser: {
          name: "Safari",
          flags: [
