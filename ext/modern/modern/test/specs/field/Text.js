    ...
    describe("name", function () {
      ...
      describe("configuration", function () {
        it("should add the name attribute to the inputEl", function () {
          ...
          render();
          expect(field.getComponent().input.getAttribute("name")).toEqual(
            "myname",
          );
        });
      });
        ...
        describe("removing", function () {
          describe("before render", function () {
            it("should remove the name attribute from the inputEl", function () {
              ...
              render();
              expect(
                field.getComponent().input.getAttribute("name"),
              ).toBeNull();
            });
          });
    ...
    describe("tabIndex", function () {
      ...
      describe("configuration", function () {
        it("should add the tabindex attribute to the inputEl", function () {
          create(defaultConfig);
          render();
          expect(field.getComponent().input.getAttribute("tabindex")).toEqual(
            "10",
          );
        });
      });
        ...
        describe("setting", function () {
          describe("before render", function () {
            it("should add the tabindex attribute to the inputEl", function () {
              ...
              render();
              expect(
                field.getComponent().input.getAttribute("tabindex"),
              ).toEqual("10");
            });
          });
    ...
    describe("maxLength", function () {
      ...
      describe("configuration", function () {
        it("should add the maxlength attribute to the inputEl", function () {
          create(defaultConfig);
          render();
          expect(field.getComponent().input.getAttribute("maxlength")).toEqual(
            "10",
          );
        });
      });
        ...
        describe("setting", function () {
          describe("before render", function () {
            it("should add the maxlength attribute to the inputEl", function () {
              ...
              render();
              expect(
                field.getComponent().input.getAttribute("maxlength"),
              ).toEqual("10");
            });
          });
    ...
    describe("placeHolder", function () {
      ...
      describe("configuration", function () {
        it("should add the placeholder attribute to the inputEl", function () {
          ...
          render();
          expect(
            field.getComponent().input.getAttribute("placeholder"),
          ).toEqual("testing");
        });
      });
      ...
      describe("using value 'on'", function () {
        ...
        describe("configuration", function () {
          it("should add the autocomplete attribute to the inputEl", function () {
            ...
            render();
            expect(
              field.getComponent().input.getAttribute("autocomplete"),
            ).toEqual("on");
          });
        });
      ...
      describe("using value 'on'", function () {
        ...
        describe("configuration", function () {
          it("should add the autocapitalize attribute to the inputEl", function () {
            ...
            render();
            expect(
              field.getComponent().input.getAttribute("autocapitalize"),
            ).toEqual("on");
          });
        });
      ...
      describe("using value 'on'", function () {
        ...
        describe("configuration", function () {
          it("should add the autocorrect attribute to the inputEl", function () {
            ...
            render();
            expect(
              field.getComponent().input.getAttribute("autocorrect"),
            ).toEqual("on");
          });
        });
