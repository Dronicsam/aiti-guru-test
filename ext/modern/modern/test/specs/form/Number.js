        ...
        describe("setting", function () {
          describe("before render", function () {
            it("should add the min attribute to the inputEl", function () {
              ...
              render();
              expect(field.getComponent().input.getAttribute("min")).toEqual(
                "10",
              );
            });
          });
        ...
        describe("setting", function () {
          describe("before render", function () {
            it("should add the max attribute to the inputEl", function () {
              ...
              render();
              expect(field.getComponent().input.getAttribute("max")).toEqual(
                "10",
              );
            });
          });
        ...
        describe("setting", function () {
          describe("before render", function () {
            it("should add the step attribute to the inputEl", function () {
              ...
              render();
              expect(field.getComponent().input.getAttribute("step")).toEqual(
                "10",
              );
            });
          });
        ...
        describe("removing", function () {
          describe("before render", function () {
            it("should remove the step attribute from the inputEl", function () {
              ...
              render();
              expect(
                field.getComponent().input.getAttribute("step"),
              ).toBeNull();
            });
          });
