describe("Ext.form.field.Text", function () {
  ...
  describe("binding", function () {
    ...
    describe("fields to data model", function () {
      var User, session, viewModel, scheduler;
    ...
    function getExpectedWidth() {
      var inputEl = component.inputEl,
        ...
        borders =
          ...
          component.triggerWrap.getBorderWidth("lr"),
        triggerWidth = 0;
  ...
  describe("layout", function () {
    ...
    function makeLayoutSuite(shrinkWrap, autoFitErrors) {
      describe(
        (shrinkWrap
          ? "shrink wrap " + dimensions[shrinkWrap]
        ...
        function () {
          ...
          function makeSideLabelSuite(labelAlign) {
            describe(labelAlign + " label", function () {
              ...
              // TODO: EXTJSIV-12634
              (Ext.isIE10m && !shrinkHeight ? xit : it)(
                "should layout with under error",
                function () {
                  create({
                    labelAlign: labelAlign,
                    msgTarget: "under",
              ...
              // TODO: EXTJSIV-12634
              (Ext.isIE10m && !shrinkHeight ? xit : it)(
                "should layout with hidden label and under error",
                function () {
                  create({
                    labelAlign: labelAlign,
                    hideLabel: true,
          ...
          // TODO: EXTJSIV-12634
          (Ext.isIE10m && !shrinkHeight ? xdescribe : describe)(
            "top label",
            function () {
              it("should layout", function () {
                create({
