describe("Ext.form.field.Picker", function () {
  ...
  describe("Using PickerField as a cell editor where the picker dropdown is itself an editable grid!", function () {
    var testWindow, staticField, TestModel, MyField;
    ...
    it("should work", function () {
              ...
              children: [
                {
                  ...
                  value: 123,
                  children: [
                    { id: 11, text: "Child Of Node 1", leaf: true, value: 456 },
                  ],
                },
                {
                  id: 2,
                  ...
                  value: 123,
                  children: [
                    { id: 22, text: "Child Of Node 2", leaf: true, value: 456 },
                  ],
                },
                {
                  id: 3,
                  ...
                  value: 123,
                  children: [
                    { id: 33, text: "Child Of Node 3", leaf: true, value: 456 },
                  ],
                },
                {
                  id: 4,
                  ...
                  value: 123,
                  children: [
                    { id: 44, text: "Child Of Node 4", leaf: true, value: 456 },
                  ],
                },
                {
                  id: 5,
                  ...
                  value: 123,
                  children: [
                    { id: 55, text: "Child Of Node 5", leaf: true, value: 456 },
                  ],
                },
                {
                  id: 6,
                  ...
                  value: 123,
                  children: [
                    { id: 66, text: "Child Of Node 6", leaf: true, value: 456 },
                  ],
                },
                {
                  id: 7,
                  ...
                  value: 123,
                  children: [
                    { id: 77, text: "Child Of Node 7", leaf: true, value: 456 },
                  ],
                },
                {
                  id: 8,
                  ...
                  value: 123,
                  children: [
                    { id: 88, text: "Child Of Node 8", leaf: true, value: 456 },
                  ],
                },
                {
                  id: 9,
                  ...
                  value: 123,
                  children: [
                    { id: 99, text: "Child Of Node 9", leaf: true, value: 456 },
                  ],
                },
              ],
            },
      ...
      runs(function () {
        ...
        expect(Ext.Element.getActiveElement() === editorField.inputEl.dom).toBe(
          true,
        );
      ...
      runs(function () {
        ...
        expect(Ext.Element.getActiveElement() === staticField.inputEl.dom).toBe(
          true,
        );
      ...
      waitsFor(function () {
        return (
          ...
          !cellEditor.isVisible() &&
          !editorField.picker.isVisible()
        );
