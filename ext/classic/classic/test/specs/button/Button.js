  ...
  if (!Ext.supports.CSS3BorderRadius) {
    ...
    describe("frame", function () {
      it("should call the click listener on the wrapped table when the button is clicked", function () {
        ...
        expect(
          Ext.button.Button.prototype.frameTableListener,
        ).toHaveBeenCalled();
      });
  ...
  describe("layout", function () {
    ...
    function makeLayoutSuite(shrinkWrap, stretch) {
      ...
      function getButtonText(width, height) {
        ...
        return (
          '<div class="btn-text-content" style="' +
          style +
          'display:inline-block;background:red;">&nbsp;</div>'
        );
      }
      ...
      describe(
        shrinkWrap
          ? "shrink wrap " +
              dimensions[shrinkWrap] +
              (stretch ? " - stretched height content" : "")
        ...
        function () {
          ...
          describe("with icon", function () {
            function make(config) {
              var iconVertical =
                config.iconAlign === "top" || config.iconAlign === "bottom";
