describe("Ext.Component", function () {
  ...
  describe("enable/disable", function () {
    ...
    (Ext.isIE ? xdescribe : describe)("masking a disabled comp", function () {
      ...
      Ext.each(
        ["input", "select", "textarea", "option", "optgroup", "table"],
        function (tagName) {
  ...
  describe("component lookup by element", function () {
    ...
    describe("focusable components", function () {
      ...
      it(
        "should add " + cmpIdAttr + " attribute to the focusable element",
        function () {
      ...
      it(
        "should be able to look Component up by " + cmpIdAttr + " attribute",
        function () {
    ...
    describe("non-focusable components", function () {
      ...
      it(
        "should not add " + cmpIdAttr + " attribute to Component's elements",
        function () {
  ...
  (Ext.supports.Touch ? xdescribe : describe)(
    "scroll template methods",
    function () {
  ...
  describe("getPosition of static Component", function () {
    ...
    xit("should report the element position when not local, and the container-relative position when local", function () {
      ...
      expect(Ext.getCmp("getPositionTestWindow").getPosition()).toEqual([
        20, 20,
      ]);
      expect(Ext.getCmp("getPositionTestWindow").getPosition(true)).toEqual([
        10, 10,
      ]);
    });
  });
  ...
  describe("scrollFlags", function () {
    ...
    function createBothScrollSuite(ox, oy, expectX, expectY) {
      it(
        "should set flags with overflowX: " + ox + " & overflowY: " + oy,
        function () {
          makeComponent({
            scrollable: {
              x: ox,
  ...
  describe("initStyles", function () {
    function createSuite(scopeCss) {
      describe(
        "root classes" + (scopeCss ? " - with Ext.scopeCss == true" : ""),
        function () {
          if (scopeCss) {
            beforeEach(function () {
              Ext.scopeCss = true;
          ...
          it("should apply root classes to root level components", function () {
            ...
            expect(grandchild.el).not.toHaveCls(
  ...
  describe("mask()/unmask() methods", function () {
    ...
    it("should render the mask into the Component el by default", function () {
      ...
      expect(c.el.dom.firstChild.className).toBe(
        Ext.baseCSSPrefix + "mask " + Ext.baseCSSPrefix + "border-box",
      );
  ...
  describe("setLoading() method", function () {
    describe("mask target === main el", function () {
      ...
      it(
        "should set " + Ext.baseCSSPrefix + "mask class on the mask",
        function () {
    ...
    describe("Default mask target (document body)", function () {
      ...
      it(
        "should set " + Ext.baseCSSPrefix + "mask class on the mask el",
        function () {
      ...
      describe("with other event options", function () {
        ...
        it("should throw an error with the target option", function () {
          expect(function () {
            ...
            "Cannot add 'foo' listener to component: 'parentContainer' - 'delegate' and 'target' event options are incompatible.",
          );
        });
