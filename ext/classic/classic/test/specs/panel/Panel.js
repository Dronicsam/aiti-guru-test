    ...
    describe("collapseTool", function () {
      ...
      Ext.Array.forEach(
        ...
        function (item) {
          ...
          it(
            "should render the correct tool with default collapseMode " +
              Ext.encode(item),
            function () {
              makePanel(
                Ext.apply(
      ...
      Ext.Array.forEach(
        ...
        function (item) {
          ...
          it(
            "should render the correct tool with the collapseMode placeHolder " +
              Ext.encode(item),
            function () {
              // collapsed, collapseDirection, expectedTool
