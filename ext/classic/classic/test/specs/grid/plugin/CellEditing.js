describe("Ext.grid.plugin.CellEditing", function () {
    ...
    describe("selecting ranges", function () {
      ...
      function fireEvent(rowNum, eventName, shift) {
        jasmine.fireMouseEvent(
          view.getNode(rowNum).getElementsByTagName("td")[0],
          eventName,
          null,
          null,
          null,
  ...
  describe("the CellEditor", function () {
    ...
    describe("positioning the editor", function () {
      it('should default to "l-l?"', function () {
        ...
        waitsFor(function () {
          return (
            plugin.activeEditor && plugin.activeEditor.alignment === "l-l?"
          );
        });
      });
      ...
      it("should constrain to the view if the editor goes out of bounds", function () {
        ...
        waitsFor(function () {
          return (
            field.hasFocus &&
            field.getRegion().top ===
              Ext.fly(plugin.activeEditor.container).getRegion().top
          );
        });
      });
      ...
      it("should start the edit when ENTER is pressed", function () {
        ...
        waitsFor(function () {
          return (
            ...
            Ext.Element.getActiveElement() === node
          );
  ...
  describe("selectOnFocus", function () {
    ...
    (Ext.isGecko || Ext.isOpera || Ext.isIE11 ? xit : it)(
      "should select the text in the cell when initiating an edit",
      function () {
        // See EXTJS-12364.
        var node;
  ...
  describe("operations that refresh the view", function () {
    ...
    describe("when editing and tabbing", function () {
      function doIt(autoSync) {
        it(
          "should not complete the edit in the new position, autoSync " +
            autoSync,
          function () {
            makeGrid(null, null, {
              autoSync: autoSync,
