describe("Ext.grid.Panel", function () {
  ...
  describe("Allowing for scrollbar in HeaderContainer", function () {
    itShowsScrollbars(
      "should add scrollBarWidth to HeaderContainer's innerCt width",
      function () {
        createGrid(null, {
          height: 100,
          columns: [
  ...
  describe("reconfigure", function () {
    ...
    describe("reconfiguring with forceFit", function () {
      it("should reconfigure so each header is the same width", function () {
        ...
        headerContainerWidth = grid
          .child("headercontainer")
          .el.getViewSize().width;
  ...
  xdescribe("emptyText", function () {
    function setup(cfg) {
      cfg = Ext.apply({}, cfg || {}, {
        xtype: "grid",
        columns: [{ dataIndex: "field1" }, { dataIndex: "field2" }],
        border: false,
        width: 500,
        height: 300,
        store: [],
    ...
    function doDisableSelectionTest(disableSelection, createInstance) {
      ...
      describe(
        "when disableSelection = " +
          disableSelection +
          ", config.selModel.isSelectionModel = " +
          !!createInstance,
        function () {
