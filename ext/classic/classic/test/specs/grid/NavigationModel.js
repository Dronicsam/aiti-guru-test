describe("Ext.grid.NavigationModel", function () {
  ...
  describe("reacting to programmatic focus", function () {
    it("should set the position correctly", function () {
      ...
      waitsFor(function () {
        return (
          view.getNavigationModel().getPosition().isEqual(focusContext) &&
          Ext.Element.getActiveElement() === focusContext.getCell(true)
        );
      ...
      waitsFor(function () {
        return (
          view.getNavigationModel().getPosition().isEqual(focusContext) &&
          Ext.Element.getActiveElement() === newCell
        );
