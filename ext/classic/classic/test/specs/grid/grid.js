describe("grid-general", function () {
  ...
  function createSuite(buffered) {
    describe(
      buffered ? "with buffered rendering" : "without buffered rendering",
      function () {
        ...
        describe("autoSizeColumn", function () {
          function getPadding() {
            var cell = grid
                .getView()
                .getEl()
                .down(colRef[0].getCellInnerSelector()),
              right = Ext.supports.ScrollWidthInlinePaddingBug
                ? parseInt(cell.getStyle("padding-right"), 10)
                : 0;
        ...
        describe("selection", function () {
          function describeSelectionSuite(withLocking) {
            describe(
              withLocking ? "with locking" : "without locking",
              function () {
                var sm;
                beforeEach(function () {
        ...
        describe("reconfigure", function () {
          ...
          function makeReconfigureSuite(beforeRender) {
            ...
            describe(
              beforeRender ? "before render" : "after render",
              function () {
        ...
        if (buffered) {
          describe("buffered row rendering", function () {
            ...
            beforeEach(function () {
              ...
              this.addMatchers({
                toBeWithin: function (deviation, value) {
                  ...
                  if (deviation > 0) {
                    return (
                      actual >= value - deviation && actual <= value + deviation
                    );
                  } else {
                    return (
                      actual >= value + deviation && actual <= value - deviation
            ...
            testIt(
              "should handle removing range above the rendered view",
              function () {
            ...
            testIt(
              "should handle removing range which intersects the top of the rendered view",
              function () {
                rowHeight = bufferedRenderer.rowHeight;
            ...
            testIt(
              "should handle removing range wholly within the rendered view",
              function () {
                rowHeight = bufferedRenderer.rowHeight;
            ...
            testIt(
              "should handle removing range which intersects the bottom of the rendered view",
              function () {
                rowHeight = bufferedRenderer.rowHeight;
            ...
            testIt(
              "should handle removing range which removes everything from halfway down rendered view",
              function () {
                rowHeight = bufferedRenderer.rowHeight;
            ...
            testIt(
              "should handle removing range which removes from top to halfway down rendered view",
              function () {
                rowHeight = bufferedRenderer.rowHeight;
            ...
            testIt(
              "should handle removing range below the rendered view",
              function () {
                rowHeight = bufferedRenderer.rowHeight;
            ...
            testIt(
              "should handle removing range which encompasses the rendered view and leaves less than view size rows remaining",
              function () {
                rowHeight = bufferedRenderer.rowHeight;
            ...
            testIt(
              "should handle removing range which encompasses the rendered view",
              function () {
                rowHeight = bufferedRenderer.rowHeight;
            ...
            testIt(
              "should handle removing range which leaves less than the viewSize rows in store",
              function () {
                rowHeight = bufferedRenderer.rowHeight;
            ...
            testIt(
              "Should prepend to the rendered block when inserting at position 0",
              function () {
                var cell00;
                scrollTop = view.getScrollY();
            ...
            testIt(
              "should handle adding range above the rendered view",
              function () {
                var oldRowStartIndex;
            ...
            testIt(
              "should render rows when buffered block is less than the view size",
              function () {
                var v = viewSize,
                  targetViewSize = v - 10;
          ...
          describe("initial correction of viewSize", function () {
            describe("when rowHeight is smaller than expected and viewSize has to grow", function () {
              ...
              it("should append new rows to the view", function () {
                ...
                expect(
                  ...
                  view.bufferedRenderer.viewSize - 1,
                ]);
              });
            });
            ...
            describe("when rowHeight is larger than expected and viewSize has to shrink", function () {
              ...
              it("should append new rows to the view", function () {
                ...
                expect(
                  Ext.Array.slice(removeRangeSpy.calls[0].args, 0, 2),
                ).toEqual([
                  view.bufferedRenderer.viewSize,
                  Ext.grid.plugin.BufferedRenderer.prototype.viewSize - 1,
                ]);
        ...
        describe("locking columns", function () {
          testNonIE(
            "should synchronize horizontal scrollbar presence between locked and normal side.",
            function () {
              var indexes = [],
                fn = function () {
                  indexes.push(arguments[4]);
              ...
              expect(
                ...
                grid.lockedGrid.getView().getTargetEl().dom.offsetHeight,
              );
        ...
        describe("ensureVisible", function () {
          var success, record, htmlEl, detectedScope, rec100, rec400;
              ...
              function () {
                ...
                beforeEach(function () {
                  ...
                  if (!singleRowHeight) {
                    ...
                    var measureView = (
                        withLocking ? grid.normalGrid : grid
                      ).getView(),
                      viewHeight = measureView.getHeight();

                    singleRowHeight = Ext.fly(
                      measureView.getNode(0),
                    ).getHeight();
                    maxRowsBeforeScroll = Math.floor(
                      viewHeight / singleRowHeight,
                    );
                    viewHeight -= Ext.getScrollbarSize().width;
                    maxRowsBeforeScrollWithHorizontalScrollBar = Math.floor(
                      viewHeight / singleRowHeight,
                    );
                    ...
                    if (withLocking) {
                      borderWidth = parseInt(
                        grid.lockedGrid.getEl().getStyle("border-right-width"),
                        10,
                      );
                    }
                ...
                function expectScroll(vertical, horizontal) {
                  ...
                  if (vertical !== undefined) {
                    if (vertical) {
                      if (Ext.isMac) {
                        ...
                        expect(dom.scrollHeight).toBeGreaterThan(
                          dom.clientHeight,
                        );
                      }
                    } else {
                  ...
                  if (horizontal !== undefined) {
                    if (horizontal) {
                      if (Ext.isMac) {
                        expect(dom.scrollWidth).toBeGreaterThanOrEqual(
                          dom.clientWidth,
                        );
                      } else {
                        expect(dom.scrollWidth).toBeGreaterThan(
                          dom.clientWidth,
                        );
                      }
                    } else {
                ...
                describe("basic initial rendering functionality", function () {
                  describe("fixed width columns", function () {
                    ...
                    visibleScrollbarsIt(
                      "should show a vertical scrollbar if triggered by a horizontal scrollbar",
                      function () {
                        makeScrollGrid(
                          [
                            {
                    ...
                    visibleScrollbarsIt(
                      "should show a horizontal scrollbar if triggered by a vertical scrollbar",
                      function () {
                        makeScrollGrid(
                          [
                            {
                ...
                describe("resizing the grid", function () {
                  ...
                  describe("fixed width columns", function () {
                    ...
                    describe("horizontally", function () {
                      ...
                      visibleScrollbarsIt(
                        "should not show a vertical scrollbar if triggered by a horizontal scrollbar",
                        function () {
                ...
                describe("column operations", function () {
                  ...
                  describe("adding", function () {
                    ...
                    describe("fixed width columns", function () {
                      ...
                      describe("with variableRowHeight", function () {
                        visibleScrollbarsIt(
                          "should show a vertical scrollbar if adding causes overflow",
                          function () {
                        ...
                        visibleScrollbarsIt(
                          "should show a horizontal scrollbar if adding triggered a vertical scrollbar",
                          function () {
                            var data = makeRows(maxRowsBeforeScroll);
                            data[0].field3 = makeRowDiv(2);
                            makeScrollGrid(
                  ...
                  describe("showing", function () {
                    describe("fixed width columns", function () {
                      ...
                      describe("with variableRowHeight", function () {
                        visibleScrollbarsIt(
                          "should show a vertical scrollbar if showing causes overflow",
                          function () {
                            var data = makeRows(maxRowsBeforeScroll);
                            data[0].field3 = makeRowDiv(2);
                            makeScrollGrid(
                        ...
                        visibleScrollbarsIt(
                          "should show a horizontal scrollbar if showing triggered a vertical scrollbar",
                          function () {
                            var data = makeRows(maxRowsBeforeScroll);
                            data[0].field3 = makeRowDiv(2);
                            makeScrollGrid(
                  ...
                  describe("removing", function () {
                    describe("fixed width columns", function () {
                      ...
                      describe("with variableRowHeight", function () {
                        ...
                        visibleScrollbarsIt(
                          "should not show a horizontal scrollbar if removing triggered a vertical scrollbar removal",
                          function () {
                            var data = makeRows(maxRowsBeforeScroll);
                            data[0].field3 = makeRowDiv(2);
                            makeScrollGrid(
                  ...
                  describe("hiding", function () {
                    describe("fixed width columns", function () {
                      ...
                      describe("with variableRowHeight", function () {
                        ...
                        visibleScrollbarsIt(
                          "should not show a horizontal scrollbar if hiding triggered a vertical scrollbar removal",
                          function () {
                            var data = makeRows(maxRowsBeforeScroll);
                            data[0].field3 = makeRowDiv(2);
                            makeScrollGrid(
                ...
                describe("header sizing", function () {
                  ...
                  describe("with no vertical and no horizontal scroll", function () {
                    visibleScrollbarsIt(
                      "should stretch to the grid size",
                      function () {
                        makeScrollGrid(
                          [
                            {
                  ...
                  describe("with no vertical and horizontal scroll", function () {
                    visibleScrollbarsIt(
                      "it should stretch to the full column size",
                      function () {
                        makeScrollGrid(
                          [
                            {
                  ...
                  describe("with vertical and horizontal scroll", function () {
                    visibleScrollbarsIt(
                      "should account for the vertical scrollbar",
                      function () {
                        makeScrollGrid(
                          [
                            {
        ...
        describe("disable/enable grids", function () {
          ...
          it("should disable locking grids", function () {
            ...
            expect(
              grid.lockedGrid.headerCt.el.dom.getAttribute("tabIndex"),
            ).toBe("-1");
            ...
            expect(
              grid.normalGrid.headerCt.el.dom.getAttribute("tabIndex"),
            ).toBe("-1");
    ...
    describe("when stateful", function () {
      ...
      describe("retaining state across page loads", function () {
        ...
        function testStateId(stateId) {
          ...
          describe(
            "when columns are " + maybe + " configured with a stateId",
            function () {
  ...
  describe("BufferedStore asynchronous loading timing with rendering and preserveScrollOnReload: true", function () {
    ...
    beforeEach(function () {
      ...
      scrollSize =
        (bufferedRenderer.viewSize * 2 +
          store.leadingBufferZone +
          store.trailingBufferZone) *
        bufferedRenderer.rowHeight;
    ...
    it("should refresh the same rendered block on buffered store reload with preserveScrollOnReload: true", function () {
      var scrollDone, refreshed, startRow, endRow;
