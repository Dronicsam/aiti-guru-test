describe("grid-celledit", function () {
      ...
      function () {
        ...
        describe("events", function () {
          ...
          describe("beforeedit", function () {
            ...
            it("should prevent editing if false is returned from the CellEditor's beforestartedit event", function () {
              plugin
                .getEditor(store.getAt(0), colRef[0])
                .on("beforestartedit", function (editor, boundEl, value) {
                  // Only allow editing on rows other than the first
        ...
        describe("key handling", function () {
          ...
          it("should move to the next cell when tabbing", function () {
            ...
            waitsFor(function () {
              ...
              return (
                plugin.getActiveColumn() === colRef[1] &&
                Ext.Element.getActiveElement() ===
                  plugin.getActiveEditor().field.inputEl.dom
              );
            });
          });
          ...
          it("should move to the next row if at the last cell", function () {
            ...
            waitsFor(function () {
              return (
                plugin.getActiveColumn() === colRef[0] &&
        ...
        describe("Autorepeat TAB in ungrouped grid", function () {
          function isEditing(rowIndex, columnIndex) {
            return (
              plugin.editing &&
              plugin.activeColumn === colRef[columnIndex] &&
          ...
          webkitIt(
            "should not lose track of editing position during repeated tabbing",
            function () {
              // Begin editing 1.1
        ...
        describe("Autorepeat TAB in grouped grid", function () {
          webkitIt(
            "should not lose track of editing position when autotabbing over group headers",
            function () {
              makeGrid(
                [
                  {
        ...
        describe("Single column editing using a single editor", function () {
          ...
          webkitIt(
            "should use the same editor for same typed cells, and not blur between edits",
            function () {
              ...
              var activeEditor, lastActiveEditor;
  ...
  describe("misc", function () {
    describe("property grid editing with textfield and triggerfield - blurring test", function () {
      ...
      webkitIt(
        "should blur and hide the cell editor on focusing the tree",
        function () {
