    ...
    describe(
      ...
      function () {
        ...
        function makeGrid(noGroup, gridCfg, numRows, withSummary, groupCfg) {
          ...
          grouping = withSummary
            ? new Ext.grid.feature.GroupingSummary(groupCfg)
            : new Ext.grid.feature.Grouping(groupCfg);
        ...
        if (buffered) {
          describe("basic functionality with buffered renderer", function () {
            ...
            describe("grouping", function () {
              var bufferedRenderer, storeClearSpy;
          ...
          describe("grouping buffered stores", function () {
            it("should work", function () {
              ...
              runs(function () {
                ...
                expect(
                  view.all.item(75, true).firstChild.firstChild ===
                    view.getRow(75),
                ).not.toBe(true);
