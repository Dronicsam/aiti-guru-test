describe("Ext.selection.CheckboxModel", function () {
  var grid, view, store, checkboxModel, data, donRec, evanRec, nigeRec;
  ...
  function clickOnHeaderCheckbox() {
    jasmine.fireMouseEvent(
      checkboxModel.getHeaderCheckbox().el.dom,
      "click",
      10,
      10,
    );
  ...
  describe("multiple selection", function () {
    ...
    describe("by clicking", function () {
      ...
      (Ext.isIE ? xit : it)(
        "should select unselected records on click, and deselect selected records on click",
        function () {
          grid.focus();
