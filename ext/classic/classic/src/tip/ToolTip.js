...
Ext.define("Ext.tip.ToolTip", {
  ...
  getTargetXY: function () {
    ...
    if (me.anchor) {
      ...
      xy =
        me.anchorToTarget && !me.trackMouse
          ? me.getAlignToXY(me.anchorTarget, me.getAnchorAlign())
          : me.targetXY;
      ...
      return me.targetXY
        ? [me.targetXY[0] + mouseOffset[0], me.targetXY[1] + mouseOffset[1]]
        : mouseOffset;
    }
  },
  ...
  getAnchorPosition: function () {
    ...
    if (me.anchor) {
      ...
      if (!m) {
        Ext.raise(
          'The AnchorTip.defaultAlign value "' +
            me.defaultAlign +
            '" is invalid.',
        );
      }
  ...
  delayShow: function (trackMouse) {
    ...
    var me = this,
      xy =
        me.el && (trackMouse === false || !me.trackMouse) && me.getTargetXY();
  ...
  syncAnchor: function () {
    ...
    me.anchorEl
      .setStyle("z-index", parseInt(me.el.getZIndex(), 10) || 0 + 1)
