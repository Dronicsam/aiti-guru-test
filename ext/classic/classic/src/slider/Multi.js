...
Ext.define("Ext.slider.Multi", {
  ...
  fieldSubTpl: [
    ...
    ">",
    '<div id="{cmpId}-endEl" data-ref="endEl" class="' +
      Ext.baseCSSPrefix +
      'slider-end" role="presentation">',
    '<div id="{cmpId}-innerEl" data-ref="innerEl" class="' +
      Ext.baseCSSPrefix +
      'slider-inner" role="presentation">',
  ...
  initComponent: function () {
    ...
    me.extraFieldBodyCls =
      Ext.baseCSSPrefix + "slider-ct-" + (me.vertical ? "vert" : "horz");
  ...
  promoteThumb: function (topThumb) {
    var thumbs =
        this.thumbStack || (this.thumbStack = Ext.Array.slice(this.thumbs)),
      ln = thumbs.length,
      zIndex = 10000,
      i;
