  ...
  "Ext.grid.selection.SpreadsheetModel",
  {
    ...
    checkboxRenderer: function () {
      return (
        '<div class="' +
        Ext.baseCSSPrefix +
        'grid-row-checker" role="presentation">&#160;</div>'
      );
    },
    ...
    updateHeaderState: function () {
      ...
      var me = this,
        ...
        isChecked =
          sel &&
          sel.isRows &&
          !store.isBufferedStore &&
          storeCount > 0 &&
          storeCount === sel.getCount(),
    ...
    selectColumn: function (column, keepSelection, suppressEvent) {
      ...
      if (
        !selData ||
        !selData.isColumns ||
        selData.view !== view.ownerGrid.view
      ) {
        me.resetSelection(true);
    ...
    privates: {
      ...
      getNumbererColumn: function (col) {
        ...
        if (!result) {
          ...
          result = me.numbererColumn =
            view.headerCt.down("rownumberer") ||
  ...
  function (SpreadsheetModel) {
    ...
    if (RowNumberer) {
      SpreadsheetModel.prototype.rowNumbererTdCls =
        Ext.grid.column.RowNumberer.prototype.tdCls +
        " " +
        Ext.baseCSSPrefix +
