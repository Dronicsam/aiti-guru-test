...
Ext.define("Ext.grid.plugin.Editing", {
  ...
  onEscKey: function (e) {
    if (this.editing) {
      ...
      if (
        !(
          targetComponent &&
          targetComponent.isPickerField &&
          targetComponent.isExpanded
        )
      ) {
  ...
  getEditingContext: function (record, columnHeader) {
    ...
    result = new Ext.grid.CellContext(view).setAll(
      view,
      rowIdx,
      colIdx,
      record,
