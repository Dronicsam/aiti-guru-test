...
Ext.define("Ext.grid.column.Check", {
  ...
  updater: function (cell, value) {
    ...
    Ext.fly(cell.down(this.getView().innerSelector, true).firstChild)[
      value ? "addCls" : "removeCls"
    ](Ext.baseCSSPrefix + "grid-checkcolumn-checked");
  },
});
