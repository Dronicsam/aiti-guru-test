...
Ext.define("Ext.grid.column.Action", {
  ...
  defaultRenderer: function (
    ...
    for (i = 0; i < len; i++) {
      ...
      altText = item.getAltText
        ? item.getAltText.apply(item.scope || scope, arguments)
  ...
  enableAction: function (index, silent) {
    ...
    me.up("tablepanel")
      .el.select("." + Ext.baseCSSPrefix + "action-col-" + index)
