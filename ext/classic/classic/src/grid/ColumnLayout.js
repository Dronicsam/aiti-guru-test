...
Ext.define("Ext.grid.ColumnLayout", {
  ...
  determineScrollbarWidth: function (ownerContext) {
    var me = this,
      ...
      manageScrollbar =
        !reserveScrollbar && !vetoReserveScrollbar && grid.view.scrollFlags.y;
  ...
  finishedLayout: function (ownerContext) {
    ...
    if (view && view.scrollFlags.x) {
      if (
        viewScrollX !== undefined &&
        owner.tooNarrow &&
        owner.componentLayoutCounter
      ) {
  ...
  getScrollbarAdjustment: function (ownerContext) {
    ...
    if (scrollbarAdjustment === undefined) {
      ...
      if (
        grid.reserveScrollbar ||
        (ownerContext.manageScrollbar &&
