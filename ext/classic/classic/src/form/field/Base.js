...
Ext.define("Ext.form.field.Base", {
  ...
  onFieldMutation: function (e) {
    ...
    if (
      ...
      !(
        ...
        me.ignoreChangeRe.test(e.browserEvent.propertyName)
      )
    ) {
      if (!task) {
  ...
  isValid: function () {
    ...
    return validate
      ? me.validateValue(me.processRawValue(me.getRawValue()))
      : disabled;
  },
  ...
  beforeDestroy: function () {
    ...
    me.checkChangeTask = me.bindNotifyListener = Ext.destroy(
  ...
  privates: {
    applyBind: function (bind, currentBindings) {
      ...
      if (bindings) {
        ...
        if (
          newValueBind !== valueBinding &&
          me.getInherited().modelValidation
        ) {
