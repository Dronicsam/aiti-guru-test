...
Ext.define("Ext.form.field.HtmlEditor", {
  ...
  updateToolbar: function () {
    ...
    if (me.enableFont && !Ext.isSafari2) {
      ...
      name = (
        queriedName
          ? queriedName.split(",")[0].replace(me.reStripQuotes, "")
          : me.defaultFont
      ).toLowerCase();
