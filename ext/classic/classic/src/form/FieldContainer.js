...
Ext.define("Ext.form.FieldContainer", {
  ...
  onAdd: function (labelItem) {
    ...
    if (
      labelItem.isLabelable &&
      Ext.isGecko &&
      Ext.firefoxVersion < 37 &&
      me.layout.type === "absolute" &&
      !me.hideLabel &&
      me.labelAlign !== "top"
    ) {
  ...
  onFieldErrorChange: function () {
    if (this.combineErrors) {
      var me = this,
        ...
        invalidFields = Ext.Array.filter(
  ...
  privates: {
    applyTargetCls: function (targetCls) {
      ...
      this.containerElCls = containerElCls
        ? containerElCls + " " + targetCls
        : targetCls;
    },
