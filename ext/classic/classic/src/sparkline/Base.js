  ...
  "Ext.sparkline.Base",
  {
    ...
    updateWidth: function (width, oldWidth) {
      ...
      if (me.height == null) {
        me.setHeight(
          parseInt(
            me.measurer.getCachedStyle(dom.parentNode, "line-height"),
            10,
          ),
        );
      } else {
    ...
    updateDisplay: function () {
      ...
      if (
        ...
        if (tooltipHTML) {
          if (
            !me.lastTooltipHTML ||
            tooltipHTML[0] !== me.lastTooltipHTML[0] ||
            tooltipHTML[1] !== me.lastTooltipHTML[1]
          ) {
