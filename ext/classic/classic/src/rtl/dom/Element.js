Ext.define(
  "Ext.rtl.dom.Element",
  {
    ...
    requires: ["Ext.CompositeElementLite"],
    ...
    translatePoints: function (x, y) {
      return Ext.rootInheritedState.rtl
        ? this.rtlTranslatePoints(x, y)
        : this.callParent(arguments);
    },

    translateXY: function (x, y) {
      return Ext.rootInheritedState.rtl
        ? this.rtlTranslateXY(x, y)
        : this.callParent(arguments);
    },
  ...
  function () {
    ...
    function cacheRtlScrollFlag() {
      var el = Ext.getBody().createChild({
          tag: "div",
          style:
            "direction:rtl;position:absolute;overflow:auto;height:100px;width:100px;",
          children: [
            {
              tag: "div",
