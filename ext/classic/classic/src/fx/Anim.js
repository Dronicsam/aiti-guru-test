  ...
  constructor: function (config) {
    ...
    if (!me.easingFn) {
      ...
      if (me.easingFn && me.easingFn.length === 5) {
        curve = me.easingFn;
        me.easingFn = Ext.fx.CubicBezier.cubicBezier(
          +curve[1],
          +curve[2],
          +curve[3],
          +curve[4],
      ...
      if (to.hasOwnProperty(attr)) {
        ...
        if (!Ext.fx.PropertyHandler[attr]) {
          if (Ext.isObject(end)) {
            ...
            propHandler = me.propHandlers[attr] =
              Ext.fx.PropertyHandler.defaultHandler;
          }
        }
        // Use custom handler
        else {
