...
Ext.define(
  "Ext.panel.Panel",
  {
    ...
    collapse: function (direction, animate) {
      ...
      if (
        me.collapsed ||
        me.fireEvent("beforecollapse", me, direction, animate) === false
      ) {
        return me;
      }
        ...
        result = Ext.apply(
          {
            ...
            preventRefocus: true,
            ownerCt:
              ownerCt && me.collapseMode === "placeholder" ? ownerCt : me,
        ...
        case c.DIRECTION_BOTTOM:
          ...
          for (i = 0; i < dockedItemCount; i++) {
            ...
            if (!comp.hidden) {
              if (
                comp.isHeader &&
                (!comp.dock || comp.dock === "top" || comp.dock === "bottom")
              ) {
                return comp;
              }
            }
        ...
        case c.DIRECTION_RIGHT:
          ...
          for (i = 0; i < dockedItemCount; i++) {
            ...
            if (!comp.hidden) {
              if (
                comp.isHeader &&
                (comp.dock === "left" || comp.dock === "right")
              ) {
                return comp;
              }
            }
    ...
    floatCollapsedPanel: function () {
      ...
      me.slideOutTask =
        me.slideOutTask ||
        new Ext.util.DelayedTask(me.slideOutFloatedPanel, me);
    ...
    getHeaderCollapsedClasses: function (header) {
      ...
      if (
        me.border &&
        (!me.frame || (me.frame && Ext.supports.CSS3BorderRadius))
      ) {
        ...
        if (floatable || (me.collapsible && titleCollapse)) {
          listeners = {
            click: {
              ...
              fn:
                !titleCollapse && floatable
                  ? me.floatCollapsedPanel
                  : me.toggleCollapse,
              element: "el",
              scope: me,
            },
    ...
    initBorderProps: function () {
      ...
      if (
        me.frame &&
        me.border &&
        (me.bodyBorder === false || me.bodyBorder === 0)
      ) {
    ...
    initRenderData: function () {
      ...
      if (me.bodyAriaRole) {
        ...
        if (
          !me.ariaStaticRoles[me.bodyAriaRole] &&
          me.bodyAriaRenderAttributes
        ) {
     ...
     */
    calculateConstrainedPosition: function (
      constrainTo,
      proposedPosition,
      local,
      proposedSize,
    ...
    initTools: function () {
      ...
      if (
        me.collapsible &&
        !(me.hideCollapseTool || me.header === false || me.preventHeader)
      ) {
        me.updateCollapseTool();
    ...
    placeholderCollapse: function (direction, animate) {
      ...
      if (me.rendered) {
        ...
        if (
          collapseTool &&
          Ext.ComponentManager.getActiveComponent() === collapseTool
        ) {
    ...
    placeholderExpand: function (animate) {
      ...
      if (
        expandTool &&
        Ext.ComponentManager.getActiveComponent() === expandTool
      ) {
        ...
        expandTool._ariaLabel =
          expandTool.ariaEl.dom.getAttribute("aria-label");
    ...
    updateCollapseTool: function () {
      ...
      if (!collapseTool && me.collapsible) {
        me.collapseDirection =
          me.collapseDirection || me.getHeaderPosition() || "top";
    ...
    fireDefaultButton: function (e) {
      ...
      //<debug>
        ...
        Ext.raise({
          msg:
            'No component found for defaultButton reference "' +
            me.defaultButton +
            '" in ' +
            me.xtype +
            " " +
        ...
        Ext.raise({
          msg:
            'Component referenced by defaultButton config "' +
            me.defaultButton +
            '" in ' +
            me.xtype +
            " " +
    ...
    updateHeader: function (force) {
            ...
            Ext.merge(
              {
                ...
                ignoreBorderManagement:
                  me.frame || me.ignoreHeaderBorderManagement,
      ...
      if (title && me.ariaRole === "region") {
        ...
        if (headingEl) {
          ...
          if (me.rendered) {
            me.headingEl = Ext.dom.Helper.insertFirst(
              me.el,
              {
                tag: "div",
                id: me.id + "-headingEl",
