...
Ext.define("Ext.panel.Table", {
  ...
  initComponent: function () {
    ...
    bufferedRenderer =
      me.plugins &&
      Ext.Array.findBy(me.plugins, function (p) {
  ...
  onRender: function () {
    ...
    if (me.isLocked && me.getSizeModel().width.shrinkWrap) {
      ...
      //</debug>
      gridPanelBorderWidth =
        me.gridPanelBorderWidth ||
        (me.gridPanelBorderWidth = me.el.getBorderWidth("lr"));
  ...
  getView: function () {
    ...
    if (!me.view) {
      ...
      if (me.view.emptyText) {
        me.view.emptyText =
          '<div class="' + me.emptyCls + '">' + me.view.emptyText + "</div>";
      }
  ...
  getLhsMarker: function () {
    ...
    return (
      me.lhsMarker ||
      (me.lhsMarker = Ext.DomHelper.append(
        me.el,
        {
          role: "presentation",
  ...
  getRhsMarker: function () {
    ...
    return (
      me.rhsMarker ||
      (me.rhsMarker = Ext.DomHelper.append(
        me.el,
        {
          role: "presentation",
          cls: me.resizeMarkerCls,
  ...
  privates: {
    ...
    setActionableMode: function (enabled, position) {
      ...
      if (
        !me.destroying &&
        me.view.setActionableMode(enabled, position) !== false
      ) {
