...
Ext.define("Ext.panel.Header", {
  ...
  requires: ["Ext.panel.Title", "Ext.panel.Tool"],
  ...
  afterLayout: function () {
    ...
    if (me.vertical) {
      ...
      if (frameTR) {
        ...
        xPos =
          me.getWidth() -
          frameTR.getPadding("r") -
          (frameTL ? frameTL.getPadding("l") : me.el.getBorderWidth("l")) +
          "px";
  ...
  privates: {
    ...
    getFramingInfoCls: function () {
      ...
      if (
        !me.expanding &&
        owner &&
        (owner.collapsed || me.isCollapsedExpander)
      ) {
    ...
    syncNoBorderCls: function () {
      ...
      if (
        ownerCt
          ? ownerCt.border === false && !ownerCt.frame
          : me.border === false
      ) {
