...
Ext.define("Ext.button.Button", {
  ...
  mixins: ["Ext.mixin.Queryable", "Ext.util.KeyboardInteractive"],
  ...
  setMenu: function (menu, destroyMenu, /* private */ initial) {
    ...
    if (menu) {
      ...
      if (ariaDom) {
        ...
        ariaAttr = me.isSplitButton
          ? me.ariaArrowElAttributes || (me.ariaArrowElAttributes = {})
      ...
      if (me.rendered) {
        ...
        ariaAttr = me.isSplitButton
          ? me.ariaArrowElAttributes
          : me.ariaRenderAttributes;
  ...
  getSplitCls: function () {
    ...
    return me.split
      ? me.baseCls +
          ...
          me.arrowCls +
          " " +
          (me.baseCls + "-" + me.arrowCls + "-" + me.arrowAlign)
      : "";
  },
  ...
  isWithinTrigger: function (e) {
    ...
    overPosition =
      me.arrowAlign === "right" ? e.getX() - me.getX() : e.getY() - el.getY();
    triggerRegion = me.getTriggerRegion();
    return (
      overPosition > triggerRegion.begin && overPosition < triggerRegion.end
    );
  },
  ...
  privates: {
    ...
    getTdCls: function () {
      return (
        Ext.baseCSSPrefix + "button-" + this.ui + "-" + this.scale + "-cell"
      );
    },
