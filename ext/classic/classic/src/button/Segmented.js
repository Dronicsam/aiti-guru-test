...
Ext.define("Ext.button.Segmented", {
  ...
  requires: ["Ext.button.Button", "Ext.layout.container.SegmentedButton"],
  ...
  applyValue: function (value, oldValue) {
    ...
    oldValues =
      oldValue instanceof Array ? oldValue : oldValue == null ? [] : [oldValue];
  ...
  privates: {
    ...
    _onItemToggle: function (button, pressed) {
      ...
      var me = this,
        ...
        buttonValue =
          button.value != null ? button.value : me.items.indexOf(button),
        value = me.getValue(),
        valueIndex;
