...
Ext.define("Ext.tree.ViewDropZone", {
  ...
  queueExpand: function (node) {
    this.expandProcId = Ext.Function.defer(
      this.expandNode,
      this.expandDelay,
      this,
      [node],
  ...
  isValidDropPoint: function (node, position, dragZone, e, data) {
    ...
    if (position === "append" && targetNode.get("allowDrop") === false) {
      ...
      position !== "append" &&
      targetNode.parentNode.get("allowDrop") === false
    ) {
      return false;
    }
    ...
    return (
      view.fireEvent("nodedragover", targetNode, position, data, e) !== false
    );
  },
