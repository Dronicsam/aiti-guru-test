...
Ext.define("Ext.util.Floating", {
  ...
  onMouseDown: function (e) {
    ...
    if (
      ...
      skipFronting =
        Ext.WindowManager.getActive() === me &&
  ...
  syncHidden: function () {
    var me = this,
      ...
      hierarchicallyHidden = (me.hierarchicallyHidden =
        me.isHierarchicallyHidden()),
  ...
  setZIndex: function (index) {
    ...
    if (me.floatingDescendants) {
      index =
        Math.floor(me.floatingDescendants.setBase(index) / 100) * 100 + 10000;
    }
    return index;
  },
