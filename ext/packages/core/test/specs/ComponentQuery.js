describe("Ext.ComponentQuery", function () {
  ...
  describe("attribute value coercion", function () {
    ...
    if (
      ('should coerce "null" to match a null property value',
      function () {
    ...
    if (
      ('should coerce "false" to match a Boolean property value',
      function () {
    ...
    if (
      ('should coerce "true" to match a Boolean property value',
      function () {
    ...
    if (
      ('should coerce "undefined" to match an undefined property value',
      function () {
