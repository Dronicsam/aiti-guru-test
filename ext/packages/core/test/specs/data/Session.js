  ...
  describe("Many-to-many associations", function () {
    ...
    describe("loading a many-to-many", function () {
      ...
      it("should load both sides of a matrix", function () {
        var rufusGroupsStore = session
            .getRecord("User", userRufus.id, false)
            .groups(),
          adminUsersStore = session
            .getRecord("Group", adminGroup.id, false)
            .users(),
          peonUsersStore = session
            .getRecord("Group", peonGroup.id, false)
            .users();
      ...
      it("should allow editing on both sides of a matrix", function () {
        var billGroupsStore = session
            .getRecord("User", userBill.id, false)
            .groups(),
          rufusGroupsStore = session
            .getRecord("User", userRufus.id, false)
            .groups(),
          adminUsersStore = session
            .getRecord("Group", adminGroup.id, false)
