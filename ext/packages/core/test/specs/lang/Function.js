describe("Ext.Function", function () {
  ...
  describe("createInterceptor", function () {
    ...
    beforeEach(function () {
      ...
      interceptorFn = jasmine
        .createSpy("interceptorSpy")
        .andCallFake(function () {
          interceptorIsRunFirst = true;
        });
      interceptedFn = jasmine
        .createSpy("interceptedSpy")
        .andCallFake(function () {
  ...
  describe("createDelayed", function () {
    (Ext.isIE8 ? xit : it)(
      "should create bind to the given function to be called after x milliseconds",
      function () {
        mockTimeout();
        var fn = jasmine.createSpy(),
  ...
  describe("createSequence", function () {
    var sequence, newFn, origFn, origFnIsRunFirst, newFnIsRunAfter;
  ...
  describe("createBuffered", function () {
    (Ext.isIE8 ? xit : it)(
      "should prevent the execution of multiple calls of the buffered function within the timeout period",
      function () {
        mockTimeout();
        var fn = jasmine.createSpy(),
  ...
  describe("interceptAfter", function () {
    it("should execute interceptor after each method call", function () {
      ...
      expect(monologue.phrases).toEqual([
        "I like you",
        "I like you too",
        "I love you",
        "I love you too",
