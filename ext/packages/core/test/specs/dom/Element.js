describe(
  ...
  function () {
    ...
    function describeMethods(fly) {
      describe(
        "methods (using " + (fly ? "Ext.fly()" : "new Ext.dom.Element()") + ")",
        function () {
          var domEl, element;
          ...
          describe("clone", function () {
            var clone,
              domElInnerHTML =
                '<span class="bar" style="color:red">Some Text</span>';
            ...
            xdescribe("deprecated (EventManager)", function () {
              describe("addListener", function () {
                ...
                it("should call Ext.EventManager.on", function () {
                  ...
                  expect(Ext.EventManager.on).toHaveBeenCalledWith(
                    element,
                    "click",
                    Ext.emptyFn,
                    fakeScope,
              ...
              describe("removeListener", function () {
                ...
                it("should call Ext.EventManager.un", function () {
                  ...
                  expect(Ext.EventManager.un).toHaveBeenCalledWith(
                    element,
                    "click",
                    Ext.emptyFn,
                    fakeScope,
          ...
          (Ext.toolkit === "modern" ? describe : xdescribe)(
            "setVisible",
            function () {
              var modes = ["DISPLAY", "VISIBILITY", "OFFSETS", "CLIP"],
                classes = {
    ...
    describe("shadow", function () {
      ...
      (Ext.supports.Opacity ? it : xit)(
        "should set the opacity of the shadow when the opacity of the element is changed",
        function () {
          element.enableShadow();
    ...
    describe("events", function () {
      function makeSuite(delegated) {
        describe(
          "element " +
            (delegated
              ? "(with delegated listeners)"
              : "(with direct listeners)"),
          function () {
            var element,
              handler,
              handler2,
      ...
      describe("listener arguments", function () {
        it("should fire an event with the correct signature on every element in the bubble stack", function () {
          //sencha.jira.com/browse/EXTJS-15735
          https: var c1 = Ext.getBody().appendChild({
              id: "c1",
              cn: {
                id: "c2",
                cn: {
