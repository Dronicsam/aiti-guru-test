    ...
    return {
      ...
      statics: {
        ...
        prepareClass: function (T, mixin, data) {
          ...
          var listeners = (T.listeners = []),
            ...
            superListeners = mixin
              ? mixin.listeners
              : T.superclass.self.listeners,
            name,
            scope,
            namedScope;
          ...
          if (!T.HasListeners) {
            ...
            var HasListeners = function () {},
              SuperHL =
                T.superclass.HasListeners ||
                (mixin && mixin.HasListeners) ||
      ...
      removeManagedListener: function (item, ename, fn, scope) {
        ...
        if (typeof ename !== "string") {
          ...
          managedListeners = me.managedListeners
            ? me.managedListeners.slice()
            : [];

          ename = Ext.canonicalEventName(ename);

          for (i = 0, length = managedListeners.length; i < length; i++) {
            me.removeManagedListenerItem(
              false,
              managedListeners[i],
              item,
              ename,
      ...
      fireEventedAction: function (eventName, args, fn, scope, fnArgs) {
        var me = this,
          ...
          beforeEventName =
            eventedBeforeEventNames[eventName] ||
      ...
      addListener: function (
        ...
        if (typeof ename !== "string") {
          ...
          eventOptions =
            (me.isComponent || me.isWidget) && options.element
      ...
      removeManagedListenerItem: function (
        ...
        if (
          ...
          managedListener.item.doRemoveListener(
  ...
  function () {
    ...
    Ext.apply(proto, {
      ...
      toggleEventLogging: function (toggle) {
        Ext.util.Observable[toggle ? "capture" : "releaseCapture"](
          this,
          function (en) {
