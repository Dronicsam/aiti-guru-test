...
Ext.define("Ext.app.ViewModel", {
  ...
  bind: function (descriptor, callback, scope, options) {
    ...
    if (
      !options &&
      descriptor.bindTo !== undefined &&
      !Ext.isString(descriptor)
    ) {
      options = descriptor;
    ...
    if (!Ext.isString(descriptor)) {
      binding = new Ext.app.bind.Multi(
        descriptor,
        me,
        callback,
        scope,
      ...
      binding = new Ext.app.bind.TemplateBinding(
        descriptor,
        me,
        callback,
        scope,
  ...
  privates: {
    ...
    applyData: function (newData, data) {
      ...
      if (!data) {
         ...
         * @since 5.0.0
         */
        me.linkData = linkData = parent
          ? Ext.Object.chain(parent.getData())
          : {};
