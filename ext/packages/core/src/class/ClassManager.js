    ...
    Manager = Ext.apply(new Ext.Inventory(), {
      ...
      create: function (className, data, createdFn) {
        ...
        return new Class(ctor, data, function () {
          var postprocessorStack =
              data.postprocessors || Manager.defaultPostprocessors,
          ...
          for (i = 0, ln = postprocessorStack.length; i < ln; i++) {
            ...
            if (typeof postprocessor === "string") {
              ...
              if (postprocessorProperties === true) {
                ...
                for (
                  j = 0, subLn = postprocessorProperties.length;
                  j < subLn;
                  j++
                ) {
      ...
      processCreate: function (className, cls, clsData) {
        ...
        if (
          postprocessor.call(me, className, cls, clsData, me.processCreate) !==
          false
        ) {
  ...
  Ext.apply(Ext, {
    ...
    undefine: function (className) {
      ...
      var entry = Manager.getNamespaceEntry(className),
        scope = entry.parent
          ? Manager.lookupName(entry.parent, false)
          : Ext.global;
