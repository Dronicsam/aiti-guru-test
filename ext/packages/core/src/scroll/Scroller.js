...
Ext.define("Ext.scroll.Scroller", {
  ...
  uses: ["Ext.scroll.TouchScroller", "Ext.scroll.DomScroller"],
  ...
  isInView: function (el) {
    ...
    if (el && myEl.contains(el)) {
      ...
      result.x =
        elRegion.right > myElRegion.left && elRegion.left < myElRegion.right;
      result.y =
        elRegion.bottom > myElRegion.top && elRegion.top < myElRegion.bottom;
    }
    return result;
  },
