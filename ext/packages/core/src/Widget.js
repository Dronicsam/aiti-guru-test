...
Ext.define(
  "Ext.Widget",
  {
    ...
    afterCachedConfig: function () {
      ...
      prototype.renderTemplate = renderTemplate =
    ...
    privates: {
      ...
      doAddListener: function (
        ...
        if (options && "element" in options) {
          ...
          me[options.element].doAddListener(
            name,
            fn,
            scope || me,
            options,
      ...
      initElementListeners: function (elementConfig) {
        ...
        if (prototype.hasOwnProperty("_elementListeners")) {
          ...
          elementListeners = prototype._elementListeners = superElementListeners
            ? Ext.Object.chain(superElementListeners)
            : {};
        }
