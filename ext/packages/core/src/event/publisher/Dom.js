  ...
  "Ext.event.publisher.Dom",
  {
    ...
    unsubscribe: function (element, eventName, delegated, capture) {
      ...
      if (delegated && !me.directEvents[eventName]) {
        ...
        if (
          !me.handles[eventName] &&
          !bubbleSubscribers[eventName] &&
    ...
    afterEvent: function (e) {
      ...
      if (
        !this.reEnterCount &&
        GlobalEvents.hasListeners.idle &&
        !GlobalEvents.idleEventMask[type]
      ) {
    ...
    reset: function () {
      ...
      // (see isEventBlocked)
      self.lastScreenPointerEventTime =
        self.lastTouchEndTime =
