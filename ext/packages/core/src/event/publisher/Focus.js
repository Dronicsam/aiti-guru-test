...
Ext.define(
  "Ext.event.publisher.Focus",
  {
    ...
    requires: ["Ext.dom.Element", "Ext.GlobalEvents"],
    ...
    doDelegatedEvent: function (e, invokeAfter) {
      ...
      if (e) {
        if (e.type === "focusout") {
          ...
          me.processFocusIn(
            e,
            relatedTarget == null || !relatedTarget.tagName
              ? document.body
              : relatedTarget,
            e.target,
            invokeAfter,
    ...
    processFocusIn: function (e, fromElement, toElement, invokeAfter) {
      ...
      focusEnterEvent = me.createSyntheticEvent(
        "focusenter",
        e,
        toElement,
        fromElement,
          ...
          if (e) {
            ...
            if (e.type === "blur") {
              ...
              me.processFocusIn(
                ...
                e.target === window ? document.body : e.target,
                invokeAfter,
              );
            }
          }
