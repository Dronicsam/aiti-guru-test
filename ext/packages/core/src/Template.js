...
Ext.define(
  "Ext.Template",
  {
    ...
    compile: function () {
      ...
      me.fn = me.useEval
        ? me.evalCompiled(code)
        : new Function("Ext", code)(Ext); // jshint ignore:line
      me.compiled = true;
      return me;
    },
  ...
  function (Template) {
    ...
    Ext.String.format = Ext.util.Format.format = function (format) {
      var formatFn =
        formatFns[format] || (formatFns[format] = generateFormatFn(format));
