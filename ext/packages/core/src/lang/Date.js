...
Ext.Date = (function () {
  ...
  if (!Date.prototype.toISOString) {
    Date.prototype.toISOString = function () {
      var me = this;
      return (
        pad(me.getUTCFullYear(), 4, "0") +
        "-" +
        pad(me.getUTCMonth() + 1, 2, "0") +
        "-" +
        pad(me.getUTCDate(), 2, "0") +
        "T" +
  ...
  return (utilDate = {
    ...
    isValid: function (y, m, d, h, i, s, ms) {
      ...
      var dt = utilDate.add(
        new nativeDate(y < 100 ? 100 : y, m - 1, d, h, i, s, ms),
        utilDate.YEAR,
        y < 100 ? y - 100 : 0,
      );
    ...
    parseCodes: {
      ...
      D: function () {
        for (
          var a = [], i = 0;
          i < 7;
          a.push(utilDate.getShortDayName(i)), ++i
      ...
      M: function () {
        for (
          var a = [], i = 0;
          i < 12;
          a.push(utilDate.getShortMonthName(i)), ++i
      ...
      c: function () {
        ...
        return {
          ...
          s: [
            ...
            arr[3].s,
            ":",
            arr[4].s, // hour AND minute, delimited by a single colon (optional). MUST be preceded by either a "T" or a single blank space
            "(?::",
            arr[5].s,
            ")?", // seconds (optional)
    ...
    isDST: function (date) {
      ...
      return (
        new nativeDate(date.getFullYear(), 0, 1).getTimezoneOffset() !==
    ...
    clearTime: function (date, clone) {
      ...
      if (date.getDate() !== d) {
        ...
        for (
          hr = 1, c = utilDate.add(date, utilDate.HOUR, hr);
          c.getDate() !== d;
          hr++, c = utilDate.add(date, utilDate.HOUR, hr)
        );
