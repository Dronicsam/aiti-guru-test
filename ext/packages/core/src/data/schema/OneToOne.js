...
Ext.define("Ext.data.schema.OneToOne", {
  ...
  Right: Ext.define(null, {
    ...
    onValueChange: function (leftRecord, session, newValue) {
      ...
      var me = this,
        rightRecord =
          leftRecord[me.getOldInstanceName()] ||
          me.getAssociatedItem(leftRecord),
      ...
      if (!hasNewValue) {
        ...
        leftRecord[instanceName] =
          session.peekRecord(cls, newValue) || undefined;
      }
      ...
      if (rightRecords) {
        ...
        if (rightRecord) {
          if (session) {
            ...
            setKey =
              (refs && refs[leftRecord.id]) || data[fieldName] === undefined;
          } else {
            setKey = true;
          }
