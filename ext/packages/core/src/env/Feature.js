...
Ext.feature = {
  ...
  isStyleSupported: function (name, tag) {
    ...
    if (
      typeof elementStyle[name] !== "undefined" ||
      typeof elementStyle[Ext.browser.getStylePrefix(name) + cName] !==
        "undefined"
    ) {
      return true;
    }
  ...
  tests: [
    ...
    },
    {
      ...
      fn: function (doc) {
        return (
          "boxShadow" in doc.documentElement.style ||
    ...
    },
    {
      ...
      fn: function () {
        ...
        if (
          ...
          return (
            (Ext.supports.TouchEvents && maxTouchPoints !== 1) ||
            maxTouchPoints > 1
          );
        } else {
    ...
    },
    {
      ...
      fn: function () {
        ...
        var bodyElement = document.createElement("div"),
          ...
          contentElement = innerElement.appendChild(
     ...
     */
    {
      ...
      fn: function (doc, div) {
        ...
        return !(
          view &&
          view.getComputedStyle(div.firstChild.firstChild, null).marginRight !==
            "0px"
        );
      },
    },
     ...
     */
    {
      ...
      fn: function (doc, div, view) {
        ...
        return !(
          view &&
          view.getComputedStyle(div.lastChild, null).backgroundColor !==
            "transparent"
        );
      },
    },
     ...
     */
    {
      ...
      fn: function (doc, div) {
        ...
        return (
          ("" + div.style.backgroundImage).indexOf("gradient") !== -1 &&
          !Ext.isIE9
        );
      },
    },
     ...
     */
    {
      ...
      fn: function (doc) {
        return (
          "onmouseenter" in doc.documentElement &&
          "onmouseleave" in doc.documentElement
        );
      },
    },
     ...
     */
    {
      ...
      fn: function (doc) {
        return (
          Ext.isString(doc.documentElement.style.msTransformOrigin) &&
          Ext.isIE9m
        );
      },
    },
     ...
     */
    {
      ...
      fn: function (doc, div) {
        div.innerHTML =
          '<div id="b1" style="height:100px;width:100px;direction:rtl;position:relative;overflow:scroll">' +
     ...
     */
    {
      ...
      fn: function (doc, div) {
        div.innerHTML =
          '<div style="height:100px;width:100px;direction:rtl;overflow:scroll">' +
        ...
        return (
          innerBox.offsetLeft + innerBox.offsetWidth !==
          outerBox.offsetLeft + outerBox.offsetWidth
        );
      },
    },
     ...
     */
    {
      ...
      fn: function (doc, div) {
        div.innerHTML =
          '<div style="height:100px;width:100px;direction:rtl;overflow:auto">' +
     ...
     */
    {
      ...
      fn: function () {
        ...
        return (
          "onhashchange" in window && (docMode === undefined || docMode > 7)
        );
      },
    },
     ...
     */
    {
      ...
      fn: function (doc) {
        ...
        supports = {
          ...
          LightOnDark:
            getColor(style.color) - getColor(style.backgroundColor) > 0,
        };
