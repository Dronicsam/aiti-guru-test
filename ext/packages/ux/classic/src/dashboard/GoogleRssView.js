...
Ext.define("Ext.ux.dashboard.GoogleRssView", {
  ...
  detailTpl:
    ...
    '<div class="' +
    Ext.baseCSSPrefix +
    'dashboard-googlerss-detail-header">' +
    '<div class="' +
    Ext.baseCSSPrefix +
    'dashboard-googlerss-detail-nav">' +
    '<tpl if="parent.hasPrev">' +
    '<span class="' +
    Ext.baseCSSPrefix +
    "dashboard-googlerss-prev " +
    Ext.baseCSSPrefix +
    'dashboard-googlerss-glyph">' +
    "{parent.prevGlyph}" +
    "</span> " +
    "</tpl>" +
    ...
    '<div class="' +
    Ext.baseCSSPrefix +
    'dashboard-googlerss-title">' +
    '<a href="{link}" target=_blank>{title}</a>' +
    "</div>" +
    '<div class="' +
    Ext.baseCSSPrefix +
    'dashboard-googlerss-author">By {author} - {publishedDate:this.date}</div>' +
    "</div>" +
    '<div class="' +
    Ext.baseCSSPrefix +
    'dashboard-googlerss-detail">' +
    "{content}" +
    "</div>" +
    "</tpl>",
  ...
  summaryTpl:
    ...
    '" data-index="{#}" class="' +
    Ext.baseCSSPrefix +
    'dashboard-googlerss-preview"><br>' +
    '<span class="' +
    Ext.baseCSSPrefix +
    'dashboard-googlerss-author">By {author} - {publishedDate:this.date}</span><br>' +
    '<span class="' +
    Ext.baseCSSPrefix +
    'dashboard-googlerss-snippet">{contentSnippet}</span><br>' +
    "</div>" +
    "</tpl>",
  ...
  wrapGlyph: function (glyph) {
    ...
    if (glyphFontFamily) {
      html =
        '<span style="font-family:' + glyphFontFamily + '">' + html + "</span>";
    }
