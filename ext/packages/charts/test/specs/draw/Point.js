describe("Ext.draw.Point", function () {
  ...
  describe("add", function () {
    it(
      "should return a new point which x/y values are sums of respective " +
        "coordinates of this point and the given point",
      function () {
  ...
  describe("sub", function () {
    it(
      "should return a new point which x/y values are the difference between " +
        "the respective coordinates of this point (minuend) " +
        "and the given point (subtrahend)",
      function () {
        var p1 = new Ext.draw.Point(2, 3),
          p2 = new Ext.draw.Point(-4, 5),
          p = p1.sub(p2);
  ...
  describe("mul", function () {
    it(
      "should return a new point which x/y values are the product of multiplication of " +
        "coordinates of this point by a specified value",
      function () {
        var p = new Ext.draw.Point(2, 3),
          mp = p.mul(3);
  ...
  describe("div", function () {
    it(
      "should return a new point which x/y values are the product of division of " +
        "coordinates of this point by a specified value",
      function () {
        var p = new Ext.draw.Point(2, 3),
          dp = p.div(2);
  ...
  describe("equals", function () {
    it(
      "should check if the respective coordinates of this point " +
        "and provided point are equal",
      function () {
  ...
  describe("rotate", function () {
    it(
      "should rotate the point (around origin and an arbitrary point) " +
  ...
  describe("transform", function () {
    it(
      "should transform a point from one coordinate system to another " +
        "given a transformation matrix or its elements",
      function () {
        var p = new Ext.draw.Point(2, 0),
