  ...
  onGestureStart: function (e) {
    ...
    if (x > 0 && x < chartWidth && y > 0 && y < chartHeight) {
      ...
      for (i = 0; i < axes.length; i++) {
          ...
          Ext.apply(
            {
              ...
              width:
                axisWidth -
                lineWidth -
                (axisAlignment === "vertical" && titleBBox
                  ? titleBBox.width
                  : 0),
              height:
                axisHeight -
                lineWidth -
                (axisAlignment === "horizontal" && titleBBox
                  ? titleBBox.height
                  : 0),
              translationX:
        ...
        crosshairLabelConfig =
          axesConfig.label || axesConfig[axisPosition].label;
        axisLabel.labelText = axisLabel.add(
            ...
            x: (function () {
              switch (axisPosition) {
                case "left":
                  ...
                  return (
                    titlePadding +
                    (axisWidth - titlePadding - tickPadding) / 2 -
                    halfLineWidth
                  );
                case "right":
                  ...
                  return (
                    tickPadding +
                    (axisWidth - tickPadding - titlePadding) / 2 +
                    halfLineWidth
                  );
                default:
                  return 0;
            ...
            y: (function () {
              switch (axisPosition) {
                case "top":
                  ...
                  return (
                    titlePadding +
                    (axisHeight - titlePadding - tickPadding) / 2 -
                    halfLineWidth
                  );
                case "bottom":
                  ...
                  return (
                    tickPadding +
                    (axisHeight - tickPadding - titlePadding) / 2 +
                    halfLineWidth
                  );
                default:
                  return 0;
