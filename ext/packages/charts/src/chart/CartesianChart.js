...
Ext.define("Ext.chart.CartesianChart", {
  ...
  performLayout: function () {
    ...
    for (
      i = 0, ln = me.surfaceMap.grid && me.surfaceMap.grid.length;
      i < ln;
      i++
    ) {
  ...
  refloatAxes: function () {
    ...
    for (i = 0; i < axesCount; i++) {
      ...
      switch (axis.getPosition()) {
        ...
        case "bottom":
          axisRect[1] =
            inset.top + inner.top + (alongAxis ? value : height - value);
          break;
        case "left":
        ...
        case "right":
          axisRect[0] =
            inset.left + inner.left + (alongAxis ? value : width - value) - 1;
          break;
      }
