...
Ext.define("Ext.chart.label.Callout", {
  ...
  setAttrs: function (attr, changes) {
    ...
    if (
      "callout" in changes ||
      "calloutPlaceX" in changes ||
      "calloutPlaceY" in changes ||
      "x" in changes ||
      "y" in changes
    ) {
      var rotationRads =
          "rotationRads" in changes
        ...
        calloutPlaceX =
          "calloutPlaceX" in changes
            ? changes.calloutPlaceX
            : attr.calloutPlaceX,
        calloutPlaceY =
          "calloutPlaceY" in changes
            ? changes.calloutPlaceY
            : attr.calloutPlaceY,
        calloutVertical =
          "calloutVertical" in changes
            ? changes.calloutVertical
            : attr.calloutVertical,
        temp;
